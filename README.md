...
## v0.3.1 Inventory action update

Inventory now separates action buttons from view tabs:

- **Scan to Add** opens a barcode lookup entry panel.
- **Manual Entry** opens a manual add form shell.
- **Scan to Use / Remove** opens an amber use/remove mode panel.
- **Export insurance CSV** remains a top action.
- Inventory view tabs are now only **List** and **By Room**.

This keeps scan-to-use from feeling like a view and makes add methods clearer.
