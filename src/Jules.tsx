  ...
  const handleSubmit = async () => {
    ...
    try {
      await onSubmit({
        ...
        service_date: date,
        recurrence_months: recurrence ? parseInt(recurrence, 10) : null,
        cost: cost ? parseFloat(cost) : null,
        vet_name: defaultVet,
        notes: null,
      });
