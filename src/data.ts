...
export const inventoryItems = [
  ...
  { id: 'i3', name: 'Air fryer', brand: 'Ninja', location: 'Kitchen', category: 'Appliance', quantity: 1, expires: null, value: 129.0 },
...
export const vehicles = [
  {
    ...
    miles: 134000,
    type: 'Gas',
    urgent: ['Spark plugs overdue', 'Transmission fluid unknown'],
    ok: ['Brakes completed 2025', 'Tire rotation at 133,900 mi']
  },
  {
    name: '2013 Nissan Leaf',
    miles: 82500,
    type: 'EV',
    urgent: ['12V auxiliary battery likely due', 'HV battery health check'],
...
export const students = [
  {
    displayName: 'Andrea',
    goal: 'Finish current study plan checkpoint',
    grow: 'Goal: complete D316 checkpoint. Reality: already on study plan. Options: keep steady pace and use course resources. Will: send update by Friday.',
    copied: false
  },
  {
    displayName: 'A.',
    goal: 'Increase weekly study time',
    grow: 'Goal: get back on track. Reality: progress slowed. Options: block study time and ask for help early. Will: set aside focused study this week.',
    copied: true
  }
];
